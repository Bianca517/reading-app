...
export default function BookDescriptionView({bookID, bookCoverImageUrl, bookTitle, bookAuthor}: props) {
    ...
    return(
            <View style={styles.body}>
                ...
                <View style={styles.buttonsContainer}>
                    ...
                    <TouchableOpacity style={styles.startReadingButton}  activeOpacity={0.5}>
